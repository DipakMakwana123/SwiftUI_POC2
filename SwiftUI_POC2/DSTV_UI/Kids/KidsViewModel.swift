...
class KidsViewModel: ObservableObject{
    ...
    @Published var lists: [HorizontalModel] = [
        ...
        HorizontalModel(id: "1",title: "Movies", selected: false, subItems: [
            ListItem(title: "Origins",
                      description: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book",
                      videoURL: "https://bit.ly/swswift",
                      time: "11:30 : 12:00",
        ...
        HorizontalModel(id: "2",title: "Animation",selected: false,subItems: [
        ...
        HorizontalModel(id: "3",title: "Live Action", selected: false, subItems: [
